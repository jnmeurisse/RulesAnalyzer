...
namespace fwm {
	...
	class RuleOutputOptions : public Options<RuleOutputOption>
	{
	public:
	...
	*/
	...
	{
	public:
		Rule(const std::string& name, int id, RuleStatus status, RuleAction action, PredicatePtr& predicate, Firewall& firewall);
		Rule(const Rule& other);

		/* Appends the rule representation to the given row.
		*/
		void output(Row* row, const RuleOutputOptions& options) const;
