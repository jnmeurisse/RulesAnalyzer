...
namespace fwm {
	...
	*/
	...
	{
	public:
		/* Allocates a new cell having 'col_count' columns.
		*/
		...
		*/
		size_t width(size_t col_idx) const noexcept;
	...
	public:
		...
		*/
		...
		/* Returns a pointer to a row in this table.
		...
		*/
		...
		/* Merges the other table with this table.  The values of
		...
		*/
		...
		/* Appends the other table to this table.  The values of
		...
		*/
		size_t col_width(size_t col_idx) const noexcept;

		/* Returns the position where text wraps in column.
		*/
		inline const WrapPositions& wrap_positions() const { return _wrap_positions; }
