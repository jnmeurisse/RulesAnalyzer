...
namespace fos {
	...
	ObjectStore::ObjectStore(const csv_reader_config& reader_config, const fqdn_resolver_config& resolver_config) :
		_initialized{ false },
		_fqdn_resolver{ resolver_config },
		_addresses{ reader_config, _fqdn_resolver },
		_address_pools{ reader_config },
		_address_resolver{ _addresses, _address_pools },
		_services{ reader_config },
		_service_pools{ reader_config },
		_service_resolver{ _services, _service_pools },
		_applications{ reader_config },
		_application_pools{ reader_config },
		_application_resolver{ _applications, _application_pools},
		_users{ reader_config },
		_user_pools{ reader_config },
